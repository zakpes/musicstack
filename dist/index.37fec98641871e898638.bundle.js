...
document.querySelector("#formSearchInput").addEventListener("focus", function () {
    flip1(1);
});
document.querySelector("#formSearchInput").addEventListener("blur", function () {
    flip1(0);
});
...
function flip1(f) {
    ...
    document.querySelector("#find_focus").value = f;
    return true;
}
// EXTERNAL MODULE: ./src/js/find.js
var find = __webpack_require__(23);
